...
(function() {
  ...
  window.SkillsBox = (function() {
    ...
    SkillsBox.prototype.giveControl = function() {
      this.setCursorPos(new Position(0, 0));
      return this.ui.controlState = new CsSkillsBox(this.ui, this);
    };
  ...
  CsSkillsBox = (function(_super) {
    __extends(CsSkillsBox, _super);

    function CsSkillsBox(ui, boxObj) {
      this.ui = ui;
      this.boxObj = boxObj;
    }

    CsSkillsBox.prototype.skillAt = function(cp) {
      return this.boxObj.getCell(cp).hasClass('skill');
    };

    CsSkillsBox.prototype.f = function() {
      return this.boxObj.onF();
    };

    CsSkillsBox.prototype.d = function() {
      this.boxObj.box.find('.selected').removeClass('selected');
      this.boxObj.skillInfoBox.hide();
      return this.boxObj.onD();
    };

    CsSkillsBox.prototype.left = function() {
    ...
    CsSkillsBox.prototype.right = function() {
      var cp, cp1;
      cp = this.boxObj.cursorPos;
      cp1 = new Position(cp.i, cp.j + 1);
    ...
    CsSkillsBox.prototype.up = function() {
    ...
    CsSkillsBox.prototype.down = function() {
      var cp, cp1;
      cp = this.boxObj.cursorPos;
      cp1 = new Position(cp.i + 1, cp.j);
