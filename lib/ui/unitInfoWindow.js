...
(function() {
  ...
  window.ViewportOverlay = (function() {
  ...
  window.UnitInfoWindow = (function() {
    function UnitInfoWindow(ui) {
      ...
      this.skillInfoBox = new SkillInfoBox(this.ui, skillInfoBoxEl);
      skillsEl = $('.invisible .tab-content-skills .skills-box');
      this.skillsBox = new SkillsBox(this.ui, skillsEl, this.skillInfoBox);
    }
    ...
    UnitInfoWindow.prototype.initInventoryTab = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        item = _ref[_i];
        inv.append(item.getElement(this.unit.canUse(item)));
      }
  ...
  CsUnitInfoWindow = (function(_super) {
    ...
    CsUnitInfoWindow.prototype.s = function() {
      if (this.windowObj.getSelectedLabel().hasClass('tab-label-skills')) {
