...
(function() {
  ...
  _turn.Turn = (function() {
    ...
    Turn.prototype.getAvailable = function(unit, options) {
      var alt, available, dest, dist, i, j, k, map, noLimit, perm, popClosest, pos, pos2, posDist, prev, prevPos, queue, queuePerm, unitAt, _i, _j, _k, _len, _ref, _ref1, _ref2;
      if (options == null) {
        options = {};
      }
    ...
    Turn.prototype.getDirections = function(totalRange) {
      var di, dirs, dj, range, _i, _j, _k, _len, _ref;
      dirs = [];
      _ref = totalRange.array;
