...
(function() {
  ...
  window.Unit = (function() {
    ...
    Unit.prototype.setTeam = function(team) {
      ...
      return this.imageObjects.done.src = prefix + 'done/' + filename;
    };
    ...
    Unit.prototype.calcCombatStats = function() {
      if ((this.equipped == null) || this.equipped.weight <= this.con) {
        this.attackSpeed = this.speed;
      } else {
        this.attackSpeed = this.speed - this.equipped.weight + this.con;
      }
    ...
    Unit.prototype.render = function(ui, ctx) {
      ...
      return ctx.drawImage(image, offset.j + 1, offset.i + 2);
    };
