...
(function() {
  ...
  _enc.Battle = (function(_super) {
    ...
    Battle.prototype.calcBattleStats = function() {
      ...
      defCanAttack = this.def.equipped.range.contains(this.dist) && !this.def.hasStatus(_status.Defend);
      if (defCanAttack) {
    ...
    Battle.prototype.showSkillMessage = function(skill) {
      ...
      afterFadeIn = (function(_this) {
        return function() {
          return setTimeout(afterDelay, _this.delay * 2 / 3);
        };
      })(this);
      afterDelay = (function(_this) {
        return function() {
          return _this.message.fadeOut(_this.delay / 5);
        };
      })(this);
      this.message = skill.getMessageEl();
      this.message.addClass('blue-box').appendTo(this.container);
      return this.message.hide().fadeIn(this.delay / 5, afterFadeIn);
    };
