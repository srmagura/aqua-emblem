...
(function() {
  ...
  terrain.Thicket = (function(_super) {
    __extends(Thicket, _super);
  ...
  window.Map = (function() {
      ...
      for (i = _i = 0, _ref = this.height - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
        _results.push((function() {
          ...
          for (j = _j = 0, _ref1 = this.width - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; j = 0 <= _ref1 ? ++_j : --_j) {
            x0 = j * tw - ui.origin.j;
            y0 = i * tw - ui.origin.i;
            ctx.fillStyle = this.tiles[i][j].color;
    ...
    Map.prototype.renderGrid = function(ui, ctx) {
      var borderColor, drawHorizontal, drawVertical, gridWidth, i, j, normalColor, tw, _i, _j, _ref, _ref1;
      tw = ui.tw;
      gridWidth = 2;
