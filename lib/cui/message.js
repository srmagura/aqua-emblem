...
(function() {
  ...
  _cui.MessageBox = (function() {
    ...
    MessageBox.prototype.showVictoryMessage = function() {
      return this.showMessage('Victory!', 'victory-message', {}, this.ui.doneVictory, null, false);
    };

    MessageBox.prototype.showDefeatMessage = function() {
      return this.showMessage('Defeat.', 'defeat-message', {}, this.ui.doneDefeat, null, false);
    };
