...
(function() {
  ...
  _skill.Temper = (function(_super) {
    ...
    function Temper() {
      ...
      this.desc = 'Temporarily buff an ally\'s strength.';
      this.mp = 9;
      this.range = new Range(0, 1);
    }

    Temper.prototype.doEffect = function(target) {
      return target.addStatus(new _status.Buff('str', 3));
    };
  ...
  _skill.Protect = (function(_super) {
    ...
    function Protect() {
      ...
      this.desc = 'Temporarily buff an ally\'s defence.';
      this.mp = 7;
      this.range = new Range(0, 1);
    }

    Protect.prototype.doEffect = function(target) {
      return target.addStatus(new _status.Buff('def', 3));
    };
