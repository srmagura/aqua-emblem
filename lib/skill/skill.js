...
(function() {
  ...
  _skill.type.None = (function(superClass) {
  ...
  _skill.type.Magic = (function(superClass) {
    extend(Magic, superClass);
  ...
  _skill.type.Holy = (function(superClass) {
    extend(Holy, superClass);

    function Holy() {
      return Holy.__super__.constructor.apply(this, arguments);
    }

    Holy.prototype.image = 'shine';

    return Holy;

  })(_skill.type.Magic);

  _skill.type.Dark = (function(superClass) {
    extend(Dark, superClass);
  ...
  _skill.type.Physical = (function(superClass) {
    extend(Physical, superClass);
  ...
  _skill.type.Sword = (function(superClass) {
  ...
  _skill.type.Lance = (function(superClass) {
  ...
  _skill.type.Axe = (function(superClass) {
    extend(Axe, superClass);
  ...
  _skill.type.Bow = (function(superClass) {
  ...
  _skill.getMessageEl = function(options) {
  ...
  _skill.Skill = (function() {
    ...
    Skill.prototype.getExp = function() {
      return this.mp * .02 * ui.expMultiplier;
    };
  ...
  _cs.chapterui.Skill = (function(superClass) {
    extend(Skill, superClass);

    function Skill(ui1, playerTurn1, skill) {
      this.ui = ui1;
      this.playerTurn = playerTurn1;
      this.skill = skill;
      this.skillDone = bind(this.skillDone, this);
    }
    ...
    Skill.prototype.d = function() {
      ...
      this.playerTurn.handleSkill(false);
      this.ui.cursor.visible = false;
      this.ui.cursor.pos = this.playerTurn.selectedUnit.pos.clone();
      return this.ui.unitInfoBox.update();
    };
    ...
    Skill.prototype.skillDone = function(exp) {
      ...
      afterExpAdd = (function(_this) {
        return function() {
          _this.ui.controlState = new _cs.chapterui.Map(_this.ui);
