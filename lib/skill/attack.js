...
(function() {
  ...
  _skill.AttackSkill = (function(_super) {
    __extends(AttackSkill, _super);
  ...
  _skill.SwordRain = (function(_super) {
  ...
  _skill.PoisonArrow = (function(_super) {
    __extends(PoisonArrow, _super);
