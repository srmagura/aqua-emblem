...
(function() {
  _chapterui.BattleStatsPanel = (function() {
    ...
    BattleStatsPanel.prototype.init = function(battle) {
      ...
      fillHalf = (function(_this) {
        return function(unit, unitName) {
          var i, img, imgSrc, len, multEl, nTurns, nameCell, ref, results, statType, td, value;
          ...
          for (i = 0, len = ref.length; i < len; i++) {
            ...
            if (statType === 'dmg' && nTurns > 1) {
              ...
              results.push(multEl.show());
            } else {
              results.push(multEl.hide());
            }
          }
          return results;
        };
