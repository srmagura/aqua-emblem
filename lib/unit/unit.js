...
(function() {
  ...
  _unit.Unit = (function() {
    ...
    Unit.prototype.refreshInventory = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.canWield(item)) {
          if ((this.equipped == null) || this.equipped instanceof _skill.Skill) {
            this.equipped = item;
          }
          _results.push(this.totalRange = this.totalRange.union(item.range));
        } else {
    ...
    Unit.prototype.onNewTurn = function() {
      var i, status, toRemove, _i, _j, _len, _len1, _ref;
      toRemove = [];
      _ref = this.statuses;
    ...
    Unit.prototype.calcStatsInitial = function() {
      ...
      this.hp = this.maxHp;
      if (this.maxMp != null) {
        return this.mp = Math.round(this.maxMp / 2);
      }
    };
