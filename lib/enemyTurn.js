...
(function() {
  ...
  window.EnemyTurn = (function(_super) {
    ...
    EnemyTurn.prototype.doUnitTurn = function(unit) {
      var afterScroll, attackRange, avail, available, available0, eu, inRange, nextUnit, obj, target, unit1, unit2, unitAt, _i, _j, _len, _len1;
      if (unit == null) {
        ...
        afterScroll = (function(_this) {
          return function() {
            ...
            return unit.followPath(inRange[0].path, function() {
              var battle;
              battle = new Battle(_this.ui, unit, target);
